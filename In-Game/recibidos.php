								...
								while($array2 = mysqli_fetch_assoc($resultado2)){
									...
									while($array3 = mysqli_fetch_assoc($resultado3)){
										...
										if ($boolean == "no") {
											...
											echo '<tr style="background-color: lightblue"><td><a href="perfil2.php?usuario='.$usuario.'"">'.$usuario.'</a></td><td>'.$mensaje.'</td><td>'.$fecha.'</td><td><img src="img/mail.svg"></td><td><a href="borrar_mensaje.php?id_mensaje='.$id_mensaje.'&id_usuario='.$id_sesion.'"><img src="img/trashcan.svg"></a></td>';
											echo "</tr>";
											...
											echo '<tr><td><a href="perfil2.php?usuario='.$usuario.'" style="color: white;">'.$usuario.'</a></td><td>'.$mensaje.'</td><td>'.$fecha.'</td><td><img src="img/mail-read.svg"></td><td><a href="borrar_mensaje_recibido.php?id_mensaje='.$id_mensaje.'&id_usuario='.$id_sesion.'"><img src="img/trashcan.svg"></a></td></tr>';
