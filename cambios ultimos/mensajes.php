   ...
   <div class="col-lg-12 col-md-12">
    ...
    <div class="row">
     ...
     <div class="col-lg-6 col-md-12">
      ...
      <div class="row ">
        <div class="info_texto col-lg-12 col-md-12">

          <div><a href="enviados.php" style="color: white;">ENVIADOS</a></div>
          <div><a href="recibidos.php"  style="color: white;">RECIBIDOS</a></div>
