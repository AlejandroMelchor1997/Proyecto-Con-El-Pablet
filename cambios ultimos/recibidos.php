					...
					<div class="col-lg-8 col-md-12">
						...
						<div class="info_texto">
							...
							while($array2 = mysqli_fetch_assoc($resultado2)){
								...
								while($array3 = mysqli_fetch_assoc($resultado3)){
									...
									if ($boolean == "no") {
										...
										<div class="row" style="background-color: lightblue">
											<div class="col-lg-3"><a href="perfil2.php?usuario='.$usuario.'"><?php echo $usuario; ?></a></div>
											<div class="col-lg-5"><?php echo $mensaje; ?></div>
											<div class="col-lg-2"><?php echo $fecha; ?></div>
											<div class="col-lg-2">
												<img src="img/mail.svg">
												<a href="borrar_mensaje.php?id_mensaje='.$id_mensaje.'&id_usuario='.$id_sesion.'"><img src="img/trashcan.svg"></a>
											</div>	
										</div>
										<hr>
										<?php	
										...
										<div class="row">
											<div class="col-lg-3"><a href="perfil2.php?usuario='.$usuario.'" style="color: white;"><?php echo $usuario; ?></a></div>
											<div class="col-lg-5"><?php echo $mensaje; ?></div>
											<div class="col-lg-2"><?php echo $fecha; ?></div>
											<div class="col-lg-2"><img src="img/mail-read.svg">
												<a href="borrar_mensaje_recibido.php?id_mensaje='.$id_mensaje.'&id_usuario='.$id_sesion.'"><img src="img/trashcan.svg"></a></div>
											</div>
											<hr>
											<?php	
										}
								...
								<a href="mensajes.php" style="color: white;"><button  class="btn btn-dark" >Volver</button></a>
