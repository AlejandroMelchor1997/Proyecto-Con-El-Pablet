...
<body style="background-image: url(img/lol_buscador.jpg);background-repeat: no-repeat;background-size: cover;background-attachment: fixed;">
				...
				<div class="row">
					...
					<div class="col-lg-8 col-md-12">
						...
						<div class="info_texto">
							...
							$sql = "SELECT ID_USUARIO FROM inscripcion WHERE id_juego = 2";
