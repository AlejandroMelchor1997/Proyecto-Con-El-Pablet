...
<body style="background-image: url(img/ow_buscador2.png);background-repeat: no-repeat;background-size: cover;background-attachment: fixed;">
				...
				<div class="row">
					...
					<div class="col-lg-8 col-md-12">
						...
						<div class="info_texto">
							<div class="row">
								<div class="col-lg-6">Usuario</div><div class="col-lg-6">Perfil</div>
							</div>
							<hr>
							<?php
							...
							$sql = "SELECT ID_USUARIO FROM inscripcion WHERE id_juego = 3";
							...
							while ($fila = mysqli_fetch_assoc($resultado)) {
								...
								while($fila2 = mysqli_fetch_assoc($resultado2)){
									...
									<div class="row">
										...
										<?php
										echo '<div class="col-lg-6"><a href="perfil2.php?usuario='.$fila2['USUARIO'].'"><button  class="btn btn-dark" >Ver Perfil</button></a></div>';
										echo '</div><hr>';
									}
									?> 
