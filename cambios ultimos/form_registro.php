...
<head>
	...
	<script type="text/javascript">
		...
		function verificar(){
			...
			var nompattern = /^[a-zA-ZñÑáéíóúÁÉÍÓÚ]+$/;
			...
			if( !(passpattern.test(pass1))){
				alert("Error, formato de contraseña incorrecto: Tiene que tener entre 6 y 12 caracteres, letras o numeros");
				return false
			}
			if (pass1 != pass2) {
	...
	<section>
		...
		<div class="container-fluid">
			...
			<div class="col-lg-12 col-md-12">
				<div class="row">
					<div class="info_web">
						<h2>Registrate en In-Game para disfrutar de todo el contenido de la Web!!!!</h2>
					</div>
