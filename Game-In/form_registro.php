...
<head>
	...
	<script type="text/javascript">
		...
		function verificar(){
			...
			var pass2 = document.getElementById("contrasena_id").value;
			if (pass1 != pass2) {
						...
						<form onsubmit="return verificar();" action="register_controller.php" method="POST" class="info_texto" >
							...
							<div class="form-row">
								...
								<div class="form-group 	col-md-6 was-validated">
									...
									<input type="email" class="form-control" id="email_id" name="email" placeholder="Email" required="">
									<div class="invalid-feedback">
										Email vacío
									</div>
								</div>
							...
							<div class="form-row">
								<div class="form-group col-md-6 was-validated">
									...
									<input type="password" class="form-control" id="contrasena_id" name="contrasena" placeholder="Password" required="">
									<div class="invalid-feedback">
										Password vacía
									</div>
								</div>
								...
								<div class="form-group col-md-6 was-validated">
									...
									<input type="password" class="form-control" id="validar_contrasena_id" name="validar_contrasena" placeholder="Confirmar Password" required="">
									<div class="invalid-feedback">
